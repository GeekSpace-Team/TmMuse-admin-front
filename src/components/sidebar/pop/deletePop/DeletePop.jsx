...
const DeletePop = ({popupId}) => {
    const [open, setOpen] = React.useState(false);  
    const handleOpen = () => setOpen(true);
    const handleClose = () => setOpen(false);
    // const deletePopup = useState('');
    ...
    const deletePopup=()=>{
      axiosInstanse.delete('/delete-popup?id='+popupId,{headers})
      .then(response=>{
      ...
      >
        <Fade in={open}>
          ...
          <Stack direction='row' spacing={3} marginLeft={30} marginTop={3}>
            ...
            <button id='yesButton' onClick={deletePopup}>YES</button>
          </Stack>
          </Box>
        </Fade>
      </Modal>
